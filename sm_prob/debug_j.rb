...
#TF-IDF - a measure of the information content a term holds for a particular document
...
#In order to return a float value, we must perform float division. We can do this 
#by either converting one or both values to a floating point number using 
#Integer#to_f, or by using the Numeric#fdiv method as seen in the above solution
